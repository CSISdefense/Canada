...
write.csv(unique(CanadaFPDS$CanadaSector),"Lookup_CanadaSector.csv")
...
```{r AnnualSectorCanadaPercentage}
...
```{r AnnualCustomerPercentageCanada}
...
```{r AnnualDoDSubCustomerPercentageCanada}
