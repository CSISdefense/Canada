...
CanadaGDPindex$growth.1989<-CanadaExp.annual$DefenseExpenditure/
...
```{r JoiningUp}
CExp<-subset(CanadaExp.annual,select=c(CalendarYear,DefenseExpenditure.2015))
CExp$Category<-"Canada Expenditures"
CExp$DefenseVCivilian<-"DefenseVCivilian"
...
Udvc<-subset(USITC.DvC,select=c(CalendarYear,
                          ...
                          TradeValue.2015,
                          growth.1989))
colnames(CExp)[colnames(CExp)=="TradeValue.2015"]<-"value.2015"
